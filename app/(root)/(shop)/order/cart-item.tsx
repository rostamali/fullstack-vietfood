...
const CartItem = () => {
	return (
		<div className="shop-cart__items border-b-2 border-b-gray-muted py-[30px] px-[30px]">
			<div className="grid md:grid-cols-8 grid-cols-3 gap-[25px] items-center">
				...
				<div className="xl:col-span-3 md:col-span-3 col-span-3 flex gap-[12px] items-center order-1">
					<div className="product-thumbnail h-[80px] w-[80px] bg-gray-dark rounded-[6px]"></div>

					<div className="cart-product-info flex-1">
						<h2 className="text-heading-6">
							Affco Point End Beef Brisket
						</h2>
						<span className="text-base-2">Blue Black</span>
					</div>
				</div>
				{/* unit price */}
				<div className="md:text-center order-2 md:col-span-1 col-span-3">
					<div className="flex items-center justify-between">
						...
						<span className="text-base-1">$100</span>
					</div>
				</div>
				{/* product cart qty */}
