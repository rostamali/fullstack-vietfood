	...
	return (
		<div className="dashboard-col-space">
			<div className="flex items-center justify-between gap-[40px]">
				<Skeleton className="h-[50px] w-[85px] rounded-md bg-white" />
				<div className="flex items-center gap-[15px]">
					<Skeleton className="h-[50px] w-[100px] rounded-md bg-white" />
					<Skeleton className="h-[50px] w-[50px] rounded-md bg-white" />
				</div>
			</div>
					...
					<div className="grid lg:grid-cols-5 grid-cols-1 lg:gap-[40px] gap-[20px]">
						...
						<div className="lg:col-span-3 w-full xm:flex xm:items-center xm:justify-between xm:gap-[15px]">
							<div className="flex-1 grid grid-cols-5 items-center gap-[15px]">
								<Skeleton className="h-[50px] col-span-3 rounded-md bg-white" />
