...
import SelectCategory from '@/components/shared/ui/select-category';
import SetThumbnail from '@/components/shared/files/set-thumbnail';
import SelectBrand from '@/components/shared/ui/select-brand';
